...
const DairyEnzymes = () => {
  ...
  const applications = [
    "Cheese production", "Pizza cheese making", "Kefir", "Yogurts"
  ];

  const benefits = [
    "Meets the demand for healthier dairy products with reduced sugar content, and increased fiber content, that are suitable for lactose-free diets",
    "Suitable for Extended Shelf Life and UHT products without undesired off-taste",
    "Improved cost-in-use and No capital investments required",
    "Delivers traditional cheese appeal: optimal for DOP & traditional cheeses",
    "Customized chymosin/pepsin formulation",
    ...
    "Facilitates flavor intensity modification",
    "Maintains natural image and sensory appeal",
    "Enhances acidification time while maintains product sensory properties",
    ...
    "High purity product and Improved filterability in sterile dosing",
  ...
  return (
    <div className="product-page">
      {/* Navbar - Same as FunctionalSystems */}
...
<section 
  ...
  style={{
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://acidindia.in/wp-content/uploads/2022/05/dairy-enzyme.jpg')`
  }}
>
  <div className="hero-overlay">
    <div className="hero-content">
      ...
      <div className="breadcrumb">
        <Link to="/">Home</Link> &raquo; <Link to="/product-range">Product Range</Link> &raquo; <span>Dairy Enzymes</span>
      </div>
    </div>
  </div>
</section>
      ...
      <section className="description-section">
        <div className="container">
          <div className="description-content">
            <p>IFF dairy enzymes allow you to meet rising consumer demand for innovative dairy products that are lactose free, reduced in sugar and enriched in prebiotic fiber. Our dairy enzymes give cheese products their defining texture and flavor while providing advantages in UHT processing. Dairy enzymes can also improve freshness in cheese, aid in the digestion of milk and reduce the bitterness of whey.</p>
          </div>
        </div>
      </section>
