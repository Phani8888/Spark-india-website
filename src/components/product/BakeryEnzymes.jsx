...
const BakeryEnzymes = () => {
  ...
  const applications = [
    "Cakes", "Breads", "Buns", "Rolls", "Baguettes",
    "Tortillas", "Chappatis", "Parathas"
  ];
...
<section 
  ...
  style={{
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://acidindia.in/wp-content/uploads/2022/05/Bread-improvers.jpg')`
  }}
>
  <div className="hero-overlay">
    <div className="hero-content">
      <h1>Bakery Enzymes</h1>
      <div className="breadcrumb">
        <Link to="/">Home</Link> &raquo; <Link to="/product-range">Product Range</Link> &raquo; <span>Bakery Enzymes</span>
      </div>
    </div>
  </div>
</section>
      ...
      <section className="description-section">
        <div className="container">
          <div className="description-content">
            <p>Gain a finer degree of control over the bakery process and make your baked goods fresher, softer, more consistent and longer-lasting (even when dealing with challenging flour quality). By modifying the amylopectin in flour starch during baking, our enzymes help you create delicious bread that lasts longer on your consumers' shelves.</p>
            <p>IFF baking enzymes help keep baked goods fresher for longer, thus reducing food waste. Furthermore, our baking enzymes can help improve flour performance and dough stability throughout the process, leading to fewer products discarded.</p>
            <p>We offer label-friendly alternatives too, for many commonly used baking ingredients. So you can meet consumer demand for a simple and clean label, while maintaining great product quality and ensuring a robust baking process.</p>
            <p>Try our baking enzymes and put yourself on track for higher-quality products. Your consumers will thank you.</p>
          </div>
        </div>
      </section>
