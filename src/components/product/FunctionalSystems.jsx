...
const FunctionalSystems = () => {
  ...
  const applications = [
    "Ice Creams", "Frozen desserts", "Sorbets", "Kulfis",
    "Softies", "Juices", "Milkshakes", "Flavored Drinks"
  ];

  const benefits = [
    "Imparts improved consistency",
    "Imparts creamy mouthfeel",
    "Imparts warm eating properties",
    "Retards ice crystal growth during storage",
    "Ensures dust-free handling",
    "Imparts very good clean-eating properties and good flavor release",
    "Imparts fresh eating properties",
    "Imparts fine and smooth texture",
    "Imparts good body and excellent melting resistance",
    "Imparts excellent air distribution and stable overrun",
    "Prevents shrinkage during storage and provides good shape retention",
    "Improves heat shock resistance",
    "Imparts optimum water binding at recommended dosage levels",
    "Imparts chewy body",
    "Prevents colouring and flavoring being drawn out of water ice",
    "Compensates for quality reduction in low-cost recipes"
  ];
...
<section 
  ...
  style={{
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://acidindia.in/wp-content/uploads/2022/05/functional-stabilisers.jpg')`
  }}
>
  <div className="hero-overlay">
    <div className="hero-content">
      <h1>Functional Systems</h1>
      <div className="breadcrumb">
        <Link to="/">Home</Link> &raquo; <Link to="/product-range">Product Range</Link> &raquo; <span>Functional Systems</span>
      </div>
    </div>
  </div>
</section>
      ...
      <section className="description-section">
        <div className="container">
          <div className="description-content">
            <p>Suggesting a dairy functional system that entails all the consumer preferences is our main goal. Our dairy systems help you to fast-track your product development and grow your revenue. What's more, our complete solutions reduce the complexity of your inventory and lower the cost and risks of your supply chain.</p>
            <p>Our ingredients can be found in half the world's ice creams and beverages, controlling viscosity, imparting creaminess and generally improving the sensory qualities of the product for millions of consumers.</p>
            <p>From designing formulations to meet your preferred nutritional profile, to optimizing sensory properties and troubleshooting technical issues, our expertise and insights give your product the competitive edge it needs to succeed with state-of-the-art application centers of IFF around the world.</p>
          </div>
        </div>
      </section>
...
export default FunctionalSystems;