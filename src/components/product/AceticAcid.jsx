// src/components/product/AceticAcid.jsx
  ...
  return (
    <div className="product-page">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://acidindia.in/wp-content/uploads/2022/05/Product-Acetic-acid.jpg')`,
        ...
        <div className="hero-overlay">
          <div className="hero-content">
            ...
            <div className="breadcrumb">
              <Link to="/">Home</Link> &raquo; <Link to="/product-range">Product Range</Link> &raquo; <span>Acetic Acid</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className={`toggle-item ${openToggle === 'food' ? 'open' : ''}`}>
            ...
            {openToggle === 'food' && (
              <div className="toggle-content">
                <p>Acetic acid is a key raw material for the production of a wide number of products used by consumers, including paneer manufacturing, gherkins and food packaging. With our reliable network of manufacturers and suppliers we source the best quality acetic acid either through imports or through local suppliers to suit the diverse needs of customers.</p>
                
                <h4>Applications</h4>
                <ul>
                  <li>Used most commonly in commercial pickling operations</li>
                  <li>Used in condiments like mayonnaise, mustard and ketchup.</li>
                  <li>Used for seasoning various food items like salads etc.</li>
                </ul>
              </div>
            )}
          </div>
          ...
          <div className={`toggle-item ${openToggle === 'industrial' ? 'open' : ''}`}>
            ...
            {openToggle === 'industrial' && (
              <div className="toggle-content">
                <p>Acetic acid is a key raw material for the production of a wide number of products used by consumers, including washing powder, drink bottles etc. With our reliable network of manufacturers and suppliers we source the best quality acetic acid either through imports or through local suppliers to suit the diverse needs of customers.</p>
                
                <h4>Applications</h4>
                <ul>
                  <li>Used for cleaning, laundry, cooking, and many other household uses.</li>
                  <li>Farmers usually spray acetic acid on livestock silage to counter bacterial and fungal growth.</li>
                  <li>It is used for the manufacture of inks and dyes and it is also used in making perfumes.</li>
                  <li>It is involved in manufacturing of rubber and plastic industries.</li>
                </ul>
              </div>
            )}
          </div>
