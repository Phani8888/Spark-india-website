...
const Emulsifiers = () => {
  ...
  const applications = [
    "Chocolates", "Confectionery Fillings", "Low fat spreads", "Tin grease emulsions",
    "Bread", "Cream Products", "Desserts", "Dry Yeast", "Halawa", "Oils & Fats",
    "Sponge Cakes", "Swiss rolls", "Cake Bars", "Muffins", "High ratio cake",
    "Biscuits", "Donuts, Sweet Dough and Pastry", "Coffee Whitener", "Cheese",
    "Soups, sauces and dressings", "Pet food", "Margarines, Spreads and Fillings",
    "Ice cream cones"
  ];

  const benefits = [
    "Enhanced confectionery processing",
    "Provides stable low-fat emulsions",
    "Achieves Aeration",
    "Improved product quality",
    "Contributes to fat reduction",
    "Improved whipping of cake batter",
    "Increased, stable volume",
    "Yields stronger dough for easier processing and improved bread quality",
    "Homogenous and fine crumb structure",
    "RSPO certified sustainable palm based options",
    "Prevents oiling out and reduces splattering",
    "Stabilizes the fat and prevents fat separation",
    "Delays water, pH and color migration in multilayered products",
...
<section 
  ...
  style={{
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://acidindia.in/wp-content/uploads/2022/05/confectionery-emulsifiers.jpg')`
  }}
>
  <div className="hero-overlay">
    <div className="hero-content">
      ...
      <div className="breadcrumb">
        <Link to="/">Home</Link> &raquo; <Link to="/product-range">Product Range</Link> &raquo; <span>Emulsifiers</span>
      </div>
    </div>
  </div>
</section>
      ...
      <section className="description-section">
        <div className="container">
          <div className="description-content">
            <p>When water and oil would naturally separate, emulsifiers help to bring them together.</p>
            <p>But the functionality of emulsifiers goes beyond just stabilizing emulsions—they also help with essential aspects of food production, such as mouthfeel, appearance, overcoming raw material variations, and extending shelf life.</p>
            <p>Emulsifiers are used in a wide range of areas from bakery, confectionery, dairy & frozen desserts to meal solutions, snacks and oils & fats.</p>
            <p>Whether you're looking to improve quality, enhance nutrition, cut costs, or get more out of your product line, the IFF range of emulsifiers can help.</p>
          </div>
        </div>
      </section>
