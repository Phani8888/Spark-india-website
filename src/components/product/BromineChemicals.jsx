// src/components/product/BromineChemicals.jsx
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import './ProductCommon.css';

const BromineChemicals = () => {
  ...
  return (
    <div className="product-page">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://acidindia.in/wp-content/uploads/2022/05/bromine-glass.jpg')`,
      ...
      >
        <div className="hero-overlay">
          <div className="hero-content">
            <h1>Bromine & Bromine chemicals</h1>
            <div className="breadcrumb">
              <Link to="/">Home</Link> &raquo; <Link to="/product-range">Product Range</Link> &raquo; <span>Bromine & Bromine chemicals</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className={`toggle-item ${openToggle === 'food' ? 'open' : ''}`}>
            ...
            {openToggle === 'food' && (
              <div className="toggle-content">
                <p>We have associated with Solaris Chemtech which is part of the Excel Group of Companies, India's leading producer of Bromine and Bromine Chemicals. Solaris adds value to a diverse set of industries, and enjoys market leadership in the segments it operates in.<br />
                The focus of Solaris Chemtech is on basic and performance driven products derived from self-replenishing natural resources in the Rann of Kutch, Gujarat, India.</p>
                
                <h4>Liquid Bromine</h4>
                <p>Bromine (Br2) is a dark, reddish brown fuming Liquid with a suffocating odour. Bromine is highly reactive and in presence of water is a powerful oxidizing agent. It reacts vigorously with amines, olefins and phenols as well as aliphatic and aromatic Hydrocarbons, ketones and acids, brominating them either by addition or substitution.</p>
                
                <h4>Applications</h4>
                <ul><li>Pharmaceuticals</li></ul>
                
                <h4>Hydrobromic acid</h4>
                <p>A Clear colorless to yellow liquid. It is highly corrosive in nature</p>
                <h4>Applications</h4>
                <ul><li>Brominating agent for manufacture of pharmaceuticals</li></ul>
                
                <h4>N-Propyl Bromide</h4>
                <p>1-Bromopropane (n-propylbromide or nPB) is an organobromine compound with the chemical formula CH3CH2CH2Br. It is a colorless liquid that is used as a solvent. It has a characteristic hydrocarbon odor.</p>
                <h4>Applications</h4>
                <ul><li>Pharmaceuticals and Agrochemicals</li></ul>
                
                <h4>Manufacturer</h4>
                <ul><li>Solaris Chemtech</li></ul>
              </div>
            )}
          </div>
          ...
          <div className={`toggle-item ${openToggle === 'industrial' ? 'open' : ''}`}>
            ...
            {openToggle === 'industrial' && (
              <div className="toggle-content">
                ...
                <p>A Clear colorless to yellow liquid. It is highly corrosive in nature</p>
                <h4>Applications</h4>
                <ul><li>Brominating agent for manufacture of dyes, photographic chemicals etc.</li></ul>
                
                <h4>N-Propyl Bromide</h4>
                <p>1-Bromopropane (n-propylbromide or nPB) is an organobromine compound with the chemical formula CH3CH2CH2Br. It is a colorless liquid that is used as a solvent. It has a characteristic hydrocarbon odor.</p>
                <h4>Applications</h4>
                <ul><li>Agrochemicals</li></ul>
...
export default BromineChemicals;